...
2. **Create a room** and read the code on the waiting screen to your partner, who types it in and hits **Join room**. The server defaults to `wss://phoenix-zv1i.onrender.com/ws`;
